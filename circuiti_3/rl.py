...
amp_Vr = Measurement(amp_Vr_pp_values, amp_Vr_pp_errors, unit='V', name='V_pp resistenza')
...
print(fit_fase_Hl.parameters)

fit_fase_Hr = perform_fit(pulsazione, fase_Vr, fase_Hr, p0=[L_guess, 0.0], method='minuit', minuit_limits={'L': (-1,1), 'k':(-10, 10)})
plot_fit(fit_fase_Hr, plot_residuals=True, show_params=True, show_stats=True, title='Circuito RL - $\\arg(H_R(\\omega))$', save_path='./grafici/rl_fase_hr.png')
print(fit_fase_Hr.parameters)