...
\begin{center}
	\includegraphics[width=0.9\textwidth]{grafici/Immagini/configurazione michaelson.png}
...
\begin{center}
	\includegraphics[width=0.9\textwidth]{grafici/Immagini/Michaelson vetro.png}
